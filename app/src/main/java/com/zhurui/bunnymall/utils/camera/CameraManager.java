...
package com.zhurui.bunnymall.utils.camera;
...
//      }
      int width = (int) getContext().getResources().getDimension(R.dimen.ui_420);
      int height = (int) getContext().getResources().getDimension(R.dimen.ui_420);
      //下面两个确定扫描匡在正中间
