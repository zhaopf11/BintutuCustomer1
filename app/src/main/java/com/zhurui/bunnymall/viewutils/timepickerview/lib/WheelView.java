package com.zhurui.bunnymall.viewutils.timepickerview.lib;
...
import com.zhurui.bunnymall.viewutils.timepickerview.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        textColorOut = getResources().getColor(R.color.gray);
        textColorCenter = getResources().getColor(R.color.gray3);
        dividerColor = getResources().getColor(R.color.gray);
        //配合customTextSize使用，customTextSize为true才会发挥效果
        textSize = getResources().getDimensionPixelSize(R.dimen.font_30);
        ...
        if(attrs != null) {
            ...
            textSize = a.getDimensionPixelOffset(R.styleable.wheelview_textSizee,textSize);
        }
