 ...
 *
 * @Override public void onClick(View v) { DateTimePickDialogUtil dateTimePicKDialog=new
...
public class DateTimePickDialog implements DatePicker.OnDateChangedListener {
     ...
     */
    public DateTimePickDialog(Activity activity, String initDateTime, String b) {
...
//						inputDate.setText("");
    ...
    private Calendar getCalendarByInintData(String initDateTime) {
        ...
        String[] dataList = initDateTime.split("-");
